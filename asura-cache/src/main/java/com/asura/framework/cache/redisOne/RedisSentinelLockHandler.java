...
public class RedisSentinelLockHandler {
     ...
     */
    public boolean getMutexLock(String lockKey, int lockExpireTime) {
        String key = LOCK_KEY_PREFIX + lockKey;
        return redisOperations.setnx(key, String.valueOf(1), lockExpireTime);
    }
    ...
    public boolean getMutexLock(String lockKey) {
        return getMutexLock(lockKey, 5000);
    }
