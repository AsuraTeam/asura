...
public class DataTransferObjectJsonParser {
    ...
    public static boolean checkSOAReturnSuccess(String result) {
        ...
        return code == DataTransferObject.BUS_SUCCESS || code == DataTransferObject.SUCCESS;
    }
    ...
    /**
     * 根据key获取返回对象data中的boolean(只是第一层key),需要soa响应状态码是0
     *
     * @param result
     * @param key
     * @return
    ...
    public static Boolean getBooleanFromDataByKey(final String result, final String key) {
        assertSOAReturnSuccess(result);
        return Json.getBoolean(result, "data", key);
    }
