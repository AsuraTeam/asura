...
public abstract class JobStoreSupport implements JobStore, Constants {
     ...
     * </p>
     *
     * @see #resumeTriggerGroup(Connection, org.quartz.impl.matchers.GroupMatcher)
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @see #resumeAll()
     * @see #pauseTriggerGroup(Connection, org.quartz.impl.matchers.GroupMatcher)
     */
     ...
     * @throws JobPersistenceException
     */
    public int recordExecuteLog(Trigger trigger, long start, long end, String ip) throws JobPersistenceException {

        Connection conn = getNonManagedTXConnection();
        int num = 0;
        try {
            num = getDelegate().insertJobLog(conn, (CronTrigger) trigger,
                    start, end, ip);
