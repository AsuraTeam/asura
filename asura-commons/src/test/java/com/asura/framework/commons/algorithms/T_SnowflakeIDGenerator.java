...
public class T_SnowflakeIDGenerator {
    ...
    class SnowFlakeTest implements Runnable {
        ...
        public void printFile(List<String> strings) {
            ...
            try {
                out = new PrintWriter(new FileOutputStream("/Users/sence/workspace/ziroom-workspace/asura/asura-commons/src/test/java/com/asura/framework/commons/algorithms/a.txt", true));
