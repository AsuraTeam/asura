...
public class T_Json {
    ...
    public void testParseObject() throws Exception {
        String json = "{\"name\":\"chris\",\"createDate\":\"2017-02-21T18:29:33.109+0800\",\"articles\":[{\"title\":\"title\",\"context\":null}]}";
        JsonNode u = Json.parseJsonNode(json);
        JsonNode js = u.get("name");
        if (js.isValueNode()) {
            System.out.println(js.textValue());
        }
        ObjectNode ob = (ObjectNode) u;
        ob.put("name", "aaa");
    ...
    public void testParseObjectList() throws Exception {
        String json = "[{\"name\":\"chris1\",\"createDate\":\"2017-02-21T18:29:33.109+0800\",\"articles\":[{\"title\":\"title1\",\"context\":null}]},{\"name\":\"chris2\",\"createDate\":\"2016-11-07 15:25:34.034\",\"articles\":[{\"title\":\"title2\",\"context\":null}]}]";
    ...
    public void t_getString_01() throws Exception {
        ...
        assertThat(createDate, containsString(".109"));
    }
    ...
    @Test
    public void t_parse_03(){
        String json = "{\"2\":\"要加搬家员\",\"3\":\"需夜间上门\"}";
        Map<String, String> specialNeedMap = Json.getPathObject(json,new TypeReference<Map<String, String>>() {});
        Assert.assertNotNull(specialNeedMap);
    }
}