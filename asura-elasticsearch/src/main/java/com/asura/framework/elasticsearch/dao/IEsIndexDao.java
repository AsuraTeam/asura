...
public interface IEsIndexDao {
     ...
     * @return
     */
    AnalyzeResponse analyze(String indexName,String keyWords,String tokenizerName);

    boolean addAliasIndex(String indexName, String alias);

    boolean removeAliasIndex(String indexName, String alias);

    boolean isAliasExists(String indexName, String alias);
